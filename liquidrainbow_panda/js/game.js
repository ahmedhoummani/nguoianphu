...
!function(a) {
    var b = function(a) {
        function b(b, c, d) {
            "undefined" == typeof c && (c = 0), "undefined" == typeof d && (d = 0), a.call(this, b, b.stage, "FPS Meter"), 
        ...
        return __extends(b, a), b.prototype.initBackground = function() {
            ...
            b.beginFill(0, 1), b.drawRect(0, 0, a, 22), b.endFill(), this.bg = new Phaser.Image(this.game, -12, -9, "test"), 
            this.bg.setTexture(b.generateTexture()), this.add(this.bg), b.destroy(), b = null;
...
!function(a) {
    var b = function() {
        function a() {}
        return a.GAME_WIDTH = 640, a.GAME_HEIGHT = 832, a.HALF_GAME_WIDTH = .5 * a.GAME_WIDTH, 
...
!function(a) {
    var b = function(b) {
        ...
        return __extends(c, b), c.prototype.init = function() {
            ...
            this.load.image("rotate", "assets/graphics/rotate-phone.png"), this.load.atlasJSONHash("preloader", "assets/graphics/preloader.png", "assets/graphics/preloader.json");
        }, c.prototype.create = function() {
            this.setupStage(), this.detectWeakDevice(), this.addFPSMeter(), this.input.maxPointers = 1, 
            this.game.state.start("Preloader", !0, !1);
        }, c.prototype.setupStage = function() {
            var b = this.game.scale;
            b.scaleMode = Phaser.ScaleManager.SHOW_ALL, b.minWidth = .25 * a.Config.GAME_WIDTH, 
            b.minHeight = .25 * a.Config.GAME_HEIGHT, b.aspectRatio = a.Config.GAME_WIDTH / a.Config.GAME_HEIGHT, 
            b.pageAlignHorizontally = !0, b.pageAlignVertically = !0, this.game.device.desktop || b.forceOrientation(!1, !0), 
            b.enterIncorrectOrientation.add(this.onEnterIncorrectOrientation, this), b.leaveIncorrectOrientation.add(this.onLeaveIncorrectOrientation, this), 
            b.setScreenSize(!0), this.stage.disableVisibilityChange = !0, this.stage.backgroundColor = 11193204;
        }, c.prototype.detectWeakDevice = function() {
            var b = !1;
            if (this.game.device.desktop === !1) {
                var c = detect.parse(window.navigator.userAgent);
                this.game.device.iOS && (c.os.major < 7 && (b = !0), c.browser.family.indexOf("Chrome") > -1 && (b = !0)), 
            ...
            this.game.time.events.repeat(500, 3, this.game.scale.setScreenSize, this);
...
!function(a) {
    var b = function(b) {
        ...
        return __extends(c, b), c.prototype.create = function() {}, c.prototype.addSplash = function() {
            ...
            this.game.input.onTap.removeAll(), this.game.state.start("MainMenu", !0, !1, !0);
        }, c;
    }(Phaser.State);
    a.SplashScreen = b;
}(game || (game = {}));
...
!function(a) {
    var b = function(b) {
        function c(c, d) {
            ...
            e.context.fillStyle = "rgba(0, 0, 0, 1)", e.context.fillRect(0, 0, a.Config.GAME_WIDTH, a.Config.GAME_HEIGHT), 
            this.overlay = new Phaser.Image(c, 0, 0, e), this.overlay.visible = !1, this.overlay.exists = !1, 
        ...
        return __extends(c, b), c.prototype.changeState = function(a, b) {
            ...
            var c = this;
            this.game.input.disabled = !0, this.overlayTween && this.overlayTween.isRunning && this.overlayTween.stop(), 
            this.overlay.visible = !0, this.overlay.alpha = 0, this.overlayTween = this.game.add.tween(this.overlay).to({
                alpha: 1
            ...
            this.game.input.disabled = !1, this.overlayTween && this.overlayTween.isRunning && this.overlayTween.stop(), 
    ...
    var b = function(b) {
        ...
        return __extends(c, b), c.prototype.preload = function() {
            ...
            if (a.Main.development === !1) {
                ...
                c.x = a.Config.HALF_GAME_WIDTH - .5 * c.width - 17, c.y = a.Config.HALF_GAME_HEIGHT + .5 * c.height - 11, 
                c.angle = -90, this.load.setPreloadSprite(c);
            }
            ...
            this.loadingText = this.game.add.text(0, 0, "0%", b), this.loadingText.anchor.set(.5, .5), 
            ...
            this.load.json("texts", "assets/texts.json"), this.game.sound.usingWebAudio && (this.load.audio("tap", [ "assets/audio/tap.wav" ], !0), 
            ...
            this.load.audio("whoosh", [ "assets/audio/whoosh.wav" ], !0), this.game.device.firefox === !1 ? (this.load.audio("panda_mmm", [ "assets/audio/panda_mmm.ogg", "assets/audio/panda_mmm.m4a" ], !0), 
            this.load.audio("star_move", [ "assets/audio/star_move.ogg", "assets/audio/star_move.m4a" ], !0), 
            this.load.audio("whoosh_out", [ "assets/audio/whoosh_out.wav" ], !0)) : (this.load.audio("panda_mmm", [ "assets/audio/panda_mmm.m4a" ], !0), 
            this.load.audio("star_move", [ "assets/audio/star_move.m4a" ], !0))), this.load.audio("main_loop", [ "assets/audio/main_loop.ogg", "assets/audio/main_loop.m4a" ], !0), 
            ...
            this.initLanguage(), this.generateRestartOverlayTexture(), this.game.plugins.add(new a.StateTransition(this.game, this)), 
...
!function(a) {
    var b = function(a) {
        function b(b, c, d, e, f) {
            var g = this;
            a.call(this, b, c, d, e, f), this.callbackDelay = 20, this.callbackTimer = 0, this.clicked = !1, 
            this._callback = new Phaser.Signal(), this.anchor.set(.5, .5), this.inputEnabled = !0, 
            this.game.device.desktop && (this.input.useHandCursor = !0), this.inputEnabled && this.events.onInputDown.add(function() {
        ...
        return __extends(b, a), b.prototype.setCallbackDelay = function(a) {
            ...
            this.clicked && (this.callbackTimer += this.game.time.elapsed, this.callbackTimer >= this.callbackDelay && (this._callback.dispatch(), 
            this.clicked = !1, this.callbackTimer = 0));
        }, b.prototype.destroy = function() {
...
!function(a) {
    var b = function(a) {
        function b(b, c, d, e, f, g) {
            a.call(this, b, c, d, e, f), this.spriteSheet = e, this.textureKey1 = f, this.textureKey2 = g, 
            this.activeTextureKey = this.textureKey1, this._state = 1, this.events.onInputUp.add(this.switchTextures, this, 2);
        }
...
!function(a) {
    var b = function(b) {
        ...
        return __extends(c, b), c.prototype.init = function(a) {
            ...
            this.addBackground(), this.addOtherImages(), this.addButtons(), this.initCredits(), 
            this.initAnimation(), this.fromPreloader && (this.soundButton.input.enabled = !1, 
            this.soundButton.switchTextures(), this.game.input.onTap.addOnce(this.onFirstTap, this), 
            ...
            this.title.anchor.set(.5, .5), this.panda = this.game.add.image(a.Config.HALF_GAME_WIDTH, a.Config.GAME_HEIGHT - 50, "main_menu", "Panda0000"), 
            this.panda.anchor.set(.5, 1), this.panda.angle = -1;
            ...
            this.creditsButton.callback.add(this.toggleCredits, this), this.soundButton = new a.ToggleButton(this.game, this.playButton.x - d, this.playButton.y, "buttons", "Button_Music_On0000", "Button_Music_Off0000"), 
            this.soundButton.callback.add(function() {
                b.game.sound.mute = !b.game.sound.mute;
            }), this.game.sound.mute && this.soundButton.switchTextures(), this.moreGamesButton = new a.SimpleButton(this.game, this.playButton.x + d, this.playButton.y, "buttons", "Button_MoreGames0000"), 
            this.moreGamesButton.callback.add(this.onMoreGamesClick, this), this.moreGamesButton.visible = !1, 
            this.moreGamesButton.exists = !1, this.buttons = [ this.playButton, this.soundButton, this.creditsButton ], 
            ...
            this.credits = this.game.add.image(0, 0, "main_menu", "CreditsBoard0000"), this.credits.position.set(Math.round(.5 * (a.Config.GAME_WIDTH - this.credits.width)), Math.round(.5 * (a.Config.GAME_HEIGHT - this.credits.height))), 
            ...
            var b = this;
            this.credits.visible = !0, this.credits.alpha = 0, this.credits.y = Math.round(.5 * (a.Config.GAME_HEIGHT - this.credits.height)) + 200, 
            this.game.add.tween(this.credits).to({
                y: this.credits.y - 200,
                alpha: 1
            }, 500, Phaser.Easing.Back.Out, !0), this.playButton.input.enabled = !1, this.creditsButton.input.enabled = !1, 
            ...
            this.panda.scale.set(0, 0), this.game.add.tween(this.panda.scale).to({
                x: .85,
                y: .85
            ...
            this.game.add.tween(this.panda.scale).to({
                y: .88
            }, 600, Phaser.Easing.Sinusoidal.Out, !0, 0, 1e4, !0), this.game.add.tween(this.panda).to({
                angle: 1
            }, 1200, Phaser.Easing.Sinusoidal.Out, !0, 0, 1e4, !0);
        }, c.prototype.hideAndStartGame = function() {
            this.playButton.input.enabled = !1, this.playButton.inputEnabled = !1, this.game.changeState(a.Main.stats.tutorialViewed ? "Level" : "Tutorial");
...
!function(a) {
    var b = function(b) {
        function c(a, c) {
            b.call(this, a, c), this.allCollected = !1, this.initFruitImage(), this.initCheckImage(), 
            this.initText();
        }
        return __extends(c, b), c.prototype.setMinitask = function(a) {
            this.minitask = a, this.minitask.updatedSignal.add(this.updateText, this), this.minitask.completeSignal.addOnce(this.setAllCollected, this), 
            this.reset(), this.updateFruitImage(), this.updateText(this.minitask.itemsToComplete);
            ...
            this.checkImage.anchor.set(.5, .5), this.checkImage.exists = !1, this.checkImage.visible = !1;
            ...
            this.allCollected === !1 && (this.allCollected = !0, this.fruitImage.alpha = .4, 
            this.text.visible = !1, this.showCheckedImage());
        }, c.prototype.showCheckedImage = function() {
            this.checkImage.exists = !0, this.checkImage.visible = !0, this.checkImage.scale.set(0, 0), 
...
!function(a) {
    !function(a) {
        a[a.Fruit_1 = 0] = "Fruit_1", a[a.Fruit_2 = 1] = "Fruit_2", a[a.Fruit_3 = 2] = "Fruit_3", 
        a[a.Fruit_4 = 3] = "Fruit_4", a[a.Fruit_5 = 4] = "Fruit_5";
...
!function(a) {
    var b = function() {
        function a(a, b) {
            this._itemsToComplete = 0, this._collectedItems = 0, this._complete = !1, this._fruitType = a, 
            this._itemsToComplete = b, this._updatedSignal = new Phaser.Signal(), this._completeSignal = new Phaser.Signal();
        }
        return a.prototype.addCollectedItems = function(a) {
            this._complete === !1 && (this._collectedItems += a, this._updatedSignal.dispatch(this._itemsToComplete - this._collectedItems), 
            this._collectedItems >= this._itemsToComplete && (this._complete = !0, this._completeSignal.dispatch()));
        }, a.prototype.destroy = function() {
            this._updatedSignal.dispose(), this._updatedSignal = null, this._completeSignal.dispose(), 
...
!function(a) {
    var b = function(b) {
        function c(c) {
            b.call(this, c, 0, 0, "panda"), this.anchor.set(.5, 1), this.initAnimations(), a.Main.weakDevice === !1 && this.game.add.tween(this.scale).to({
                y: 1.05
            }, 700, Phaser.Easing.Sinusoidal.Out, !0, 0, Number.MAX_VALUE, !0);
        }
        return __extends(c, b), c.prototype.initAnimations = function() {
            this.idleAnim = this.addAnimation("idle", 0, 0), this.openMouthAnim = this.addAnimation("open_mouth", 1, 1), 
            this.chewAnim = this.addAnimation("chew", 2, 35), this.chewAnim.onComplete.add(this.onChewComplete, this), 
            this.play("idle");
        }, c.prototype.addAnimation = function(a, b, c) {
            var d = Phaser.Animation.generateFrameNames("Panda", b, c, "", 4), e = this.animations.add(a, d, 60);
            return e;
        }, c.prototype.onChewComplete = function() {
            this.play("idle");
        }, c.prototype.openMouth = function() {
            this.play("open_mouth", 60, !1), this.game.sound.usingWebAudio && Math.random() < .33 && this.game.sound.play("panda_mmm");
        }, c.prototype.chew = function() {
            this.play("chew", 60, !1), this.game.sound.usingWebAudio && this.game.sound.play("panda_chew", .75);
...
!function(a) {
    var b = function(a) {
        ...
        return __extends(b, a), b.prototype.initIcon = function() {
            ...
            this.timer && (this.timer = null), this.timer = a, this.timer.secondPassedSignal.add(this.onSecondPassed, this), 
            this.timer.stopSignal.add(this.onTimerStop, this), this.updateText(this.timer.remainingSeconds);
            ...
            var b = Math.floor(a / 60), c = a % 60, d = 10 > b ? "0" + b.toString() : b.toString(), e = 10 > c ? "0" + c.toString() : c.toString(), f = d + ":" + e;
            this.text.setText(f);
        }, b.prototype.destroy = function() {
...
!function(a) {
    var b = function(b) {
        function c(a, c) {
            b.call(this, a, c, "complete_board"), this.hideDuration = 600, this.exists = !1, 
            this.visible = !1, this._playAgainSignal = new Phaser.Signal(), this.initBack(), 
            this.initTitleText(), this.initTextContent(), this.initButtons();
        }
        return __extends(c, b), c.prototype.initBack = function() {
            ...
            this.titleText = new Phaser.Text(this.game, 0, -106, b, c), this.titleText.anchor.set(.5, .5), 
            this.titleText.stroke = "#FFFFFF", this.titleText.strokeThickness = 10, this.titleText.setShadow(2, 2, "#FB1A05", 2), 
            this.add(this.titleText);
        }, c.prototype.initTextContent = function() {
            this.addText(a.Main.texts.max_level, -40), this.maxLevelText = this.addText("10", -5), 
            this.addText(a.Main.texts.scores, 60), this.pointsText = this.addText("10450", 95);
            ...
            return d.anchor.set(.5, .5), d.setShadow(2, 2, "#FB1A05", 2), this.add(d), d;
            ...
            this.playAgainButton.callback.add(this.onPlayAgainButtonClick, this), this.quitButton = new a.SimpleButton(this.game, c, d, "buttons", "Button_Menu0000"), 
            this.quitButton.callback.add(this.onQuitButtonClick, this), this.buttons = [ this.playAgainButton, this.quitButton ], 
            this.buttons.forEach(function(a) {
            ...
            this.exists = !0, this.visible = !0, this.maxLevelText.setText(a.toString()), this.pointsText.setText(b.toString()), 
            this.showBoard(), this.showButtons();
            ...
            b.prototype.destroy.call(this, !0, !1), this.buttons = null, this._playAgainSignal.dispose(), 
    ...
    var b = function(b) {
        function c(c) {
            b.call(this, c, 0, 0, a.Main.texts.level_complete, {
                ...
                fill: "#FBAF05",
                align: "center"
            }), this.showDelay = 650, this.showDuration = 500, this.waitDelay = 750, this.hideDuration = 400, 
            this.stroke = "#FFFFFF", this.strokeThickness = 12, this.setShadow(2, 2, "#FB1A05", 3), 
            this.exists = !1, this.visible = !1, this.anchor.set(.5, .5), this.position.set(a.Config.HALF_GAME_WIDTH, a.Config.HALF_GAME_HEIGHT), 
            this._hideCompleteSignal = new Phaser.Signal(), this.events.onAddedToGroup.addOnce(this.onAddedToGroup, this);
        }
        return __extends(c, b), c.prototype.onAddedToGroup = function() {
            ...
            this.game.sound.usingWebAudio && this.game.sound.play("level_up", .5), this.exists = !0, 
            this.visible = !0, this.y = a.Config.HALF_GAME_HEIGHT + 100, this.alpha = 0, this.scale.set(0, 1), 
            this.game.add.tween(this).to({
                alpha: 1
...
!function(a) {
    var b = function(b) {
        function c(c, d) {
            b.call(this, c, d, "task_board"), this.showDuration = 400, this.waitDelay = 2e3, 
            this.hideDuration = 400, this.exists = !1, this.visible = !1, this._hideCompleteSignal = new Phaser.Signal(), 
            this.x = a.Config.HALF_GAME_WIDTH, this.initBack(), this.addLevelLabel(), this.initText(), 
            this.initFruitLabels();
        }
        return __extends(c, b), c.prototype.initBack = function() {
            this.back = this.game.add.image(0, 0, "graphics_1", "TaskBoard_Back0000", this), 
            this.back.anchor.set(.5, .5);
            ...
            this.levelLabel = this.game.add.text(0, -110, b, c, this), this.levelLabel.anchor.set(.5, .5), 
            this.levelLabel.setShadow(2, 2, "#666666"), this.add(this.levelLabel), this.game.device.firefox && (this.levelLabel.y += 10);
        }, c.prototype.initText = function() {
            ...
            this.text = this.game.add.text(0, -15, b, c, this), this.text.anchor.set(.5, .5), 
            this.text.wordWrap = !0, this.text.wordWrapWidth = .8 * this.back.width, this.text.setShadow(2, 2, "#666666"), 
            ...
            for (var e = 0; d > e; e++) {
                ...
                f.position.set(b, 55), f.exists = !1, this.labelsGroup.add(f), this.labels.push(f), 
                b += c;
            }
        }, c.prototype.show = function(b, c) {
            this.game.sound.usingWebAudio && this.game.sound.play("whoosh", .33), this.exists = !0, 
            this.visible = !0, this.updateLevelLabel(c), this.updateLabels(b), this.position.y = a.Config.HALF_GAME_HEIGHT + 100, 
            this.alpha = 0, this.scale.set(0, 1), this.game.add.tween(this.scale).to({
                x: 1
            ...
            b.prototype.destroy.call(this, !0, !1), this.labels = null, this._hideCompleteSignal.dispose(), 
...
!function(a) {
    var b = function(b) {
        function c(c, d) {
            b.call(this, c, d, "pause_board"), this.initBack(), this.initText(), this.initButtons(), 
            this.position.set(a.Config.HALF_GAME_WIDTH, a.Config.HALF_GAME_HEIGHT), this.exists = !1, 
            this.visible = !1;
        }
        return __extends(c, b), c.prototype.initBack = function() {
            ...
            d.anchor.set(.5, .5), d.stroke = "#FFFFFF", d.strokeThickness = 12, d.setShadow(2, 2, "#FB1A05", 2), 
            this.add(d), this.game.device.firefox === !1 ? d.lineSpacing = -12 : d.position.y += 10;
        }, c.prototype.initButtons = function() {
            var b = this, c = 96, d = 120;
            this._resumeButton = new a.SimpleButton(this.game, 0, c, "buttons", "Button_Resume0000"), 
            this.soundButton = new a.ToggleButton(this.game, this._resumeButton.x + d, c, "buttons", "Button_Music_On0000", "Button_Music_Off0000"), 
            this.soundButton.callback.add(function() {
                b.game.sound.mute = !b.game.sound.mute;
            }), this.game.sound.mute && this.soundButton.switchTextures(), this.menuButton = new a.SimpleButton(this.game, this._resumeButton.x - d, c, "buttons", "Button_Menu0000"), 
            this.menuButton.callback.addOnce(this.gotoMainMenu, this), this.buttons = [ this.menuButton, this._resumeButton, this.soundButton ], 
            this.buttons.forEach(function(a) {
                b.add(a);
            });
        }, c.prototype.gotoMainMenu = function() {
            ...
            this.game.sound.usingWebAudio && this.game.sound.play("whoosh", .33), this.exists = !0, 
            this.visible = !0, this.position.y = a.Config.HALF_GAME_HEIGHT + 200, this.alpha = 0, 
            this.game.add.tween(this).to({
                alpha: 1
            }, 200, Phaser.Easing.Linear.None, !0), this.game.add.tween(this.position).to({
                y: a.Config.HALF_GAME_HEIGHT
...
!function(a) {
    var b = function(b) {
        function c(a) {
            b.call(this, a, a.world, "gui"), this._restartSignal = new Phaser.Signal(), this._pauseSignal = new Phaser.Signal(), 
            this.addPanda(), this.initFruitLabels(), this.addTimer(), this.addLevelLabel(), 
            this.addPauseButton(), this.addGameCompleteBoard(), this.addLevelUpFX(), this.addTaskBoard(), 
            this.addPauseBoard(), this.addRestartOverlay();
        }
        return __extends(c, b), c.prototype.addRestartOverlay = function() {
            var a = this.game.cache.getBitmapData("restart_overlay");
            this.restartOverlay = this.game.add.image(0, 0, a, null, this), this.restartOverlay.exists = !1, 
            this.restartOverlay.visible = !1;
        }, c.prototype.showRestartOverlay = function() {
            var a = this;
            this.restartOverlay.exists = !0, this.restartOverlay.visible = !0, this.restartOverlay.alpha = 0, 
            ...
            if ("en" === a.Main.language) {
                ...
                d.anchor.set(.5, .5), d.stroke = "#296B98", d.setShadow(2, 2, "#296B98", 1), d.strokeThickness = 5, 
                d.position.set(this.timer.x + this.timer.width + 46, 38), this.levelLabel = d;
            }
            this.updateLevelLabel(1);
        }, c.prototype.addPauseButton = function() {
            var a = this;
            this.pauseButton = new game.SimpleButton(this.game, game.Config.GAME_WIDTH - 64, this._panda.y - 68, "buttons", "Button_Pause0000"), 
            this.pauseButton.callback.add(function() {
                a._pauseSignal.dispatch("pause");
            }, this), this.add(this.pauseButton);
        }, c.prototype.initFruitLabels = function() {
            this._fruitsLabels = new game.FruitLabelCollection(this.game, this), this._fruitsLabels.position.set(this._panda.x + 130, this._panda.y - 45);
            ...
            this.gameOverBoard = new game.GameOverBoard(this.game, this), this.gameOverBoard.position.set(game.Config.HALF_GAME_WIDTH, game.Config.HALF_GAME_HEIGHT), 
            ...
            this._taskBoard = new game.TaskBoard(this.game, this), this.add(this._taskBoard), 
            ...
            b.prototype.destroy.call(this, !0, !1), this._restartSignal.dispose(), this._restartSignal = null, 
            this._pauseSignal.dispose(), this._pauseSignal = null;
...
!function(a) {
    var b = function(b) {
        function c(a, c) {
            b.call(this, a, c, "grid"), this._rows = 8, this._columns = 7, this.initCells(), 
            this.addFrame();
        }
        return __extends(c, b), c.prototype.initCells = function() {
            this.cells = [];
            for (var a = !0, b = 0; b < this._rows; b++) for (var c = 0; c < this._columns; c++) {
            ...
            return f.x = a.Cell.WIDTH * c, f.y = a.Cell.HEIGHT * b, this.cells[e] = f, this.add(f), 
            f;
            ...
            var c = a - this.position.x, d = b - this.position.y, e = Math.floor(d / game.Cell.WIDTH), f = Math.floor(c / game.Cell.HEIGHT);
            return this.getCellAt(e, f);
        }, c.prototype.getWidth = function() {
            var a = this.cells[0].x, b = this.cells[this.cells.length - 1].x + this.cells[this.cells.length - 1].width;
            return b - a;
        }, c.prototype.getHeight = function() {
            var a = this.cells[0].y, b = this.cells[this.cells.length - 1].y + this.cells[this.cells.length - 1].height;
            return b - a;
        }, c.prototype.destroy = function() {
...
!function(a) {
    var b = function(b) {
        function c(c, d) {
            var e = a.ItemType[d];
            this.normalTexture = e + "0000", this.highlightedTexture = e + "_Highlighted0000", 
            b.call(this, c, 0, 0, "graphics_1", this.normalTexture), this.anchor.set(.5, .5);
        }
...
!function(a) {
    var b = function(a) {
        function b(b) {
            a.call(this, b, 0, 0, "graphics_1", "FutureBonus_10000"), this._activateSignal = new Phaser.Signal(), 
            this.anchor.set(.5, .5), this.pulseTween = this.game.add.tween(this.scale).to({
                x: .8,
                y: .8
            }, 500, Phaser.Easing.Sinusoidal.Out, !0, 0, Number.MAX_VALUE, !0), this.pulseTween.pause(), 
        ...
        return __extends(b, a), b.prototype.activate = function() {
            ...
            a.prototype.destroy.call(this, !0), this.pulseTween && (this.pulseTween.stop(), 
            this.pulseTween = null), this._activateSignal.dispose(), this._activateSignal = null;
...
!function(a) {
    var b = function(a) {
        function b(b) {
            a.call(this, b, 0, 0, "graphics_1", "ItemBonus0000"), this.followItem = !1, this.exists = !1, 
            this.visible = !1, this.alive = !1, this.anchor.set(.5, .5), this._activateSignal = new Phaser.Signal(), 
            this.initPulseTween();
        }
        return __extends(b, a), b.prototype.initPulseTween = function() {
            ...
            this.angle = this.game.rnd.normal() > 0 ? 0 : 90, this._item = a, this.position.set(this._item.x, this._item.y), 
            this.parent.sendToBack(this), this.followItem = !0, this.show();
            ...
            this._activateSignal.dispatch(this), this.pulseTween.pause(), this.followItem = !1, 
            this.hide();
            ...
            a.prototype.destroy.call(this, !0), this.pulseTween.stop(), this.pulseTween = null, 
            this._activateSignal.dispose(), this._activateSignal = null, this._item = null;
        }, Object.defineProperty(b.prototype, "activateSignal", {
            get: function() {
                return this._activateSignal;
            },
...
!function(a) {
    var b = function(b) {
        function c(a, c) {
            b.call(this, a, 0, 0, "graphics_1"), this.futurePowerUp = null, this.powerUp = null, 
            this.alive = !1, this.dropDistance = 0, this.collected = !1, this.alive = !1, this.exists = !1, 
            this.visible = !1, this.anchor.set(.5, .5), this._itemType = c, this._collectCompleteSignal = new Phaser.Signal(), 
            this.initTextures(), this.setNormalTexture(), this.initTweens();
        }
        return __extends(c, b), c.prototype.initTextures = function() {
            ...
            this.collectTween = this.game.add.tween(this.scale).to({
                x: 0,
                y: 0
            }, 300, Phaser.Easing.Back.In), this.collectTween.onComplete.add(this.onCollectComplete, this), 
            this.scale.set(0, 0), this.showOnGridTween = this.game.add.tween(this.scale).to({
                x: 1,
                y: 1
            }, 500, Phaser.Easing.Back.Out, !1, 200), this.scale.set(1, 1), this.removeFromGridTween = this.game.add.tween(this.scale).to({
                x: 0,
                y: 0
            }, 500, Phaser.Easing.Back.In), this.removeFromGridTween.onComplete.add(this.onAddToPool, this), 
            ...
            null === this.powerUp && this.setNormalTexture(), this.futurePowerUp && (this.futurePowerUp.onAddToPool(), 
            ...
            var b = utils.MathUtil.distance(this.position.x, this.position.y, a.x, a.y), c = Phaser.Math.clamp(b, 400, 800);
            this.game.add.tween(this).to({
                x: a.x,
                y: a.y - 56
            ...
            this.collected = !0, this.futurePowerUp && (this.futurePowerUp.activate(), this.futurePowerUp = null), 
            this.powerUp && (this.powerUp.activate(), this.powerUp = null);
            ...
            this.clearCell();
            var c = this.x, d = this.y, e = Phaser.Math.distance(c, d, a, b), f = 500 + 5e3 / e;
            this.game.add.tween(this).to({
                x: a,
                y: b
            }, 1.2 * e, Phaser.Easing.Cubic.In, !0, f), this.game.add.tween(this.scale).to({
                x: .33,
                y: .33
            }, .1 * e, Phaser.Easing.Back.In, !0, f + 1.1 * e).onComplete.addOnce(this.onAddToPool, this);
        }, c.prototype.onAddToPool = function() {
            this.alive = !1, this.exists = !1, this.visible = !1, this.futurePowerUp && (this.futurePowerUp.onAddToPool(), 
            this.futurePowerUp = null), this.powerUp && (this.powerUp.returnToPool(), this.powerUp = null);
        }, c.prototype.onRemoveFromPool = function() {
            this.alive = !0, this.exists = !0, this.visible = !0, this.collected = !1, this.alpha = 1, 
            this.scale.set(1, 1), this.setNormalTexture();
        }, c.prototype.destroy = function() {
            b.prototype.destroy.call(this, !0), this._collectCompleteSignal.dispose(), this._collectCompleteSignal = null, 
            this.futurePowerUp = null, this.powerUp = null, this.clearCell(), this.destroyTweens();
        }, c.prototype.destroyTweens = function() {
            this.showOnGridTween.stop(), this.showOnGridTween = null, this.collectTween.stop(), 
            this.collectTween = null, this.highlightTween.stop(), this.highlightTween = null, 
            this.removeFromGridTween.stop(), this.removeFromGridTween = null;
            ...
            enumerable: !0,
            configurable: !0
        }), c.RADIUS = 40, c.RADIUS_SQUARED = c.RADIUS * c.RADIUS, c.CONTACT_RADIUS = 120, 
        c.CONTACT_RADIUS_SQUARED = c.CONTACT_RADIUS * c.CONTACT_RADIUS, c.ITEM_TYPES = [ 0, 1, 2, 3, 4 ], 
        c;
    }(Phaser.Image);
    a.Item = b;
}(game || (game = {}));
...
!function(a) {
    var b = function() {
        ...
        return b.prototype.initItems = function() {
            ...
            return null === c && (c = new a.Item(this._game, b), this.items.push(c), this.itemsLayer.add(c)), 
...
!function(a) {
    var b = function() {
        ...
        return a.prototype.setAllowedItemTypes = function(a) {
            ...
            this.game = null, this.grid = null, this.itemRnd = null, this.addItemCallback = null, 
            this.addItemCallbackContext = null, this.allowedItemTypes = null;
        }, a;
    }();
    a.ItemsGenerator = b;
}(game || (game = {}));
...
!function(a) {
    var b = function(b) {
        function c(a) {
            b.call(this, a, 0, 0, "graphics_1", "Chain_Link0000"), this.anchor.set(.5, .5), 
            this.exists = !1, this.visible = !1, this.initTween();
        }
        return __extends(c, b), c.prototype.initTween = function() {
            ...
            this.visible = !0, this.exists = !0, a.Main.weakDevice === !1 && (this.scale.set(0, 1), 
    ...
    var b = function() {
        ...
        return a.prototype.getPossibleMove = function() {
            ...
            for (var b = a.itemType; this.stack.length > 0; ) {
                ...
                this.putInStack(c, b, -1, -1), this.putInStack(c, b, -1, 0), this.putInStack(c, b, -1, 1), 
                this.putInStack(c, b, 0, 1), this.putInStack(c, b, 1, 1), this.putInStack(c, b, 1, 0), 
                this.putInStack(c, b, 1, -1), this.putInStack(c, b, 0, -1);
            }
            return null;
...
!function(a) {
    var b = function() {
        function a(a, b) {
            this.totalSeconds = 0, this.passedSeconds = 0, this._remainingSeconds = 0, this.paused = !1, 
            this.game = a, this.totalSeconds = Math.floor(b / 1e3), this._remainingSeconds = this.totalSeconds, 
            this._secondPassedSignal = new Phaser.Signal(), this._completeSignal = new Phaser.Signal(), 
        ...
        return a.prototype.start = function() {
            ...
            this._secondPassedSignal.dispatch(this._remainingSeconds), this._remainingSeconds <= 0 && (this.stopTimer(), 
            this._completeSignal.dispatch()));
        }, a.prototype.stopTimer = function() {
            this.timerEvent && (this.game.time.events.remove(this.timerEvent), this.timerEvent = null, 
            ...
            this.stopTimer(), this._secondPassedSignal.dispose(), this._secondPassedSignal = null, 
            this._completeSignal.dispose(), this._completeSignal = null, this._stopSignal.dispose(), 
...
!function(a) {
    var b = function() {
        function b(b, c, d, e) {
            this._isComplete = !1, this.game = b, this.miniTasks = c, this._completeSignal = new Phaser.Signal(), 
            this._timer = new a.TaskTimer(this.game, d), this.allowedItemTypes = e;
        }
        return b.prototype.hasItemType = function(a) {
            ...
            this.game = null, this._completeSignal.dispose(), this._completeSignal = null, this.destroyMinitasks(), 
            this.destroyTimer();
...
!function(a) {
    var b = function() {
        ...
        return b.prototype.generateTask = function(b) {
            var c = this.getAllowedItemTypes(b), d = this.getTypesNum(b), e = this.createMinitasks(c, d, b), f = this.getTime(b);
            ...
            var b = 4, c = 3, d = 21, e = b + a * c + this.game.rnd.integerInRange(-3, 3);
            return e > d && (e = d), e;
...
!function(a) {
    var b = function(b) {
        function c(c) {
            b.call(this, c, 0, 0, "graphics_1", "BonusStar0000"), this.exists = !1, this.visible = !1, 
            this.alive = !1, this.anchor.set(.5, .5), this._requestItemSignal = new Phaser.Signal(), 
            this._moveCompleteSignal = new Phaser.Signal(), a.Main.weakDevice === !1 && this.initEmitter();
        }
        return __extends(c, b), c.prototype.initEmitter = function() {
            this.emitter = this.game.add.emitter(0, 0, 15), this.emitter.makeParticles("graphics_1", "StarParticle0000"), 
            this.emitter.setScale(1.5, .25, 1.5, .25, 1e3), this.emitter.setXSpeed(-50, 50), 
            this.emitter.setYSpeed(10, 20), this.emitter.gravity = 150, this.emitter.lifespan = 1e3;
        }, c.prototype.show = function() {
            ...
            var c = utils.MathUtil.distance(this.x, this.y, a, b), d = Phaser.Math.clamp(c, 300, 1e3);
            this.game.add.tween(this).to({
                x: a,
                y: b,
                angle: 360
            }, d, Phaser.Easing.Back.In, !0).onComplete.addOnce(this.onMoveComplete, this), 
            ...
            this.exists && this.emitter && (this.emitter.emitX = this.x, this.emitter.emitY = this.y + 15, 
            this.emitter.emitParticle());
        }, c.prototype.returnToPool = function() {
            this.onAddToPool();
        }, c.prototype.onAddToPool = function() {
            this.exists = !1, this.visible = !1, this.alive = !1, this._requestItemSignal.active = !1, 
            this._moveCompleteSignal.active = !1, this.emitter && (this.emitter.forEachExists(function(a) {
                a.exists = !1;
            }, this), this.emitter.kill());
        }, c.prototype.onRemoveFromPool = function() {
            this.exists = !0, this.visible = !0, this.alive = !0, this._requestItemSignal.active = !0, 
            this._moveCompleteSignal.active = !0, this.alpha = 1, this.emitter && this.emitter.revive();
        }, c.prototype.destroy = function() {
            b.prototype.destroy.call(this, !0), this.emitter && (this.emitter.destroy(!0, !1), 
            this.emitter = null), this._requestItemSignal.dispose(), this._requestItemSignal = null, 
            this._moveCompleteSignal.dispose(), this._moveCompleteSignal = null;
...
!function(a) {
    var b = function(a) {
        function b(b, c) {
            a.call(this, b, c), this.alive = !1, this._completeSignal = new Phaser.Signal(), 
        ...
        return __extends(b, a), b.prototype.initArrows = function() {
            ...
            this.arrow1.anchor.set(.5, .5), this.arrow2 = this.game.add.image(0, 0, "graphics_1", "PowerUp_Line0000", this), 
            this.arrow2.anchor.set(.5, .5), this.arrow2.angle = 180;
        }, b.prototype.launch = function() {
            this.showArrows();
        }, b.prototype.showArrows = function() {
            this.arrow1.visible = !0, this.arrow1.exists = !0, this.arrow1.alpha = 1, this.arrow2.visible = !0, 
            this.arrow2.exists = !0, this.arrow2.alpha = 1;
        }, b.prototype.launchArrow = function(a, b, c) {
            var d = Phaser.Math.distance(a.x, a.y, b, c), e = this.getTweenDuration(d), f = this.game.add.tween(a).to({
                x: b,
                y: c
            ...
            a.prototype.destroy.call(this, !0, !1), this.arrow1 = null, this.arrow2 = null, 
            this._completeSignal.dispose(), this._completeSignal = null;
        }, Object.defineProperty(b.prototype, "completeSignal", {
            get: function() {
                return this._completeSignal;
            },
...
!function(a) {
    var b = function(a) {
        function b(b, c, d) {
            a.call(this, b, c, d, "tutorial_hand"), this.hidden = !1, this.initAnimation(), 
            this.startTweens();
        }
        return __extends(b, a), b.prototype.initAnimation = function() {
            ...
            var a = this;
            this.hidden || (this.position.set(295, 410), this.alpha = 1, this.play("main", 30, !1), 
            this.game.add.tween(this).to({
                x: 115,
                y: 580
...
!function(a) {
    var b = function(a) {
        function b(b, c) {
            ...
            a.call(this, b, 0, 0, c, d), this.stroke = "#FFFFFF", this.strokeThickness = 8, 
            this.anchor.set(.5, .5), this.initTweens(), this.exists = !1, this.visible = !1, 
            this.alive = !1;
        }
        return __extends(b, a), b.prototype.initTweens = function() {
            ...
            this.exists = !0, this.visible = !0, this.alpha = 1, this.scale.set(0, 0), this.showTween.start(), 
            ...
            a.prototype.destroy.call(this, !0), this.showTween.stop(), this.showTween = null, 
...
!function(a) {
    var b = function(a) {
        function b(b, c) {
            ...
            a.call(this, b, 0, 0, c, d), this.stroke = "#FFFFFF", this.strokeThickness = 11, 
            this.anchor.set(.5, .5), this.initTweens(), this.exists = !1, this.visible = !1;
        }
        return __extends(b, a), b.prototype.initTweens = function() {
            this.scale.set(0, 0), this.showTween = this.game.add.tween(this.scale).to({
            ...
            this.exists = !0, this.visible = !0, this.alpha = 1, this.scale.set(0, 0), this.showTween.start(), 
            this.hideTween.start(), this.game.add.tween(this).to({
                y: this.y - 30
...
!function(a) {
    var b = function(b) {
        function c(a, c) {
            b.call(this, a, c, "bonus_time_fx"), this.initIcon(), this.initText(), this.exists = !1, 
            this.visible = !1;
        }
        return __extends(c, b), c.prototype.initIcon = function() {
            ...
            this.exists = !0, this.visible = !0, this.text.setText(b), this.setPosition(a), 
            this.alpha = 0, this.scale.set(0, 1), this.game.add.tween(this).to({
                alpha: 1
...
!function(a) {
    var b = function(b) {
        function c(a, c) {
            b.call(this, a, 0, 0, "splashes"), this.itemType = c, this.initAnimation(), this.anchor.set(.5, .5), 
            this.scale.set(1.2, 1.2);
        }
        return __extends(c, b), c.prototype.initAnimation = function() {
            var b = "Splash_" + a.ItemType[this.itemType], c = Phaser.Animation.generateFrameNames(b, 0, 19, "", 4), d = this.animations.add("main", c, 60, !1);
...
!function(a) {
    var b = function(b) {
        function c(a, c) {
            b.call(this, a, c), this.addMonkey(), this.addBasket(), this._dispatchFruitsComplete = new Phaser.Signal(), 
            this.exists = !1, this.visible = !1;
        }
        return __extends(c, b), c.prototype.addMonkey = function() {
            this.monkey = this.game.add.image(0, 0, "graphics_1", "Monkey0000", this), this.monkey.anchor.set(.5, .5);
            ...
            this.exists = !0, this.visible = !0, this.position.y = a.Config.GAME_HEIGHT - 94, 
            this.scale.set(0, 0), this.game.add.tween(this.scale).to({
                x: 1,
                y: 1
            ...
            this.show(), this.game.time.events.add(300, this.shakeBasket, this), this.game.time.events.add(2700, this.onDispatchComplete, this);
...
!function(a) {
    var b = function(b) {
        function c() {
            b.apply(this, arguments), this.chainItemType = null, this.lastItemInChain = null, 
            this.pointerDown = !1, this.pointerEnabled = !0, this.debugRenderFlag = !1;
        }
        return __extends(c, b), c.prototype.init = function() {
            this.pointerEnabled = !0, this.pointerDown = !1, this.chain = [], this.chainItemType = null, 
            this.lastItemInChain = null, this.activeItems = [], this.chainLinks = [], this.chainLinkPos = new Phaser.Point(), 
            this.shuffleDuration = 200, this.firstGridFill = !0, this.level = 1, this.chainCollected = !1, 
            this.powerUpsActivated = 0, this.powerUpsCompleted = 0, this.gameOver = !1;
        }, c.prototype.create = function() {
            this.game.state.onShutDownCallback = this.destroy, this.initRoundResult(), this.addLayers(), 
            this.itemsPool = new a.ItemsPool(this.game, this.itemsLayer), this.findChainStrategy = new a.FindChainStrategy(this.game, this.grid, this.activeItems), 
            this.initChainLinks(), this.initItemsGenerator(), this.taskGenerator = new a.TaskGenerator(this.game), 
            this.addGUI(), this.setNewTask(), this.addItems(), this.initStarsPool(), this.initPowerUpsPool(), 
            this.initPowerUpFxsPool(), this.initFuturePowerUpsPool(), this.addBonusTimeFX(), 
            this.addMonkey(), this.initKeyCallbacks(), this.game.input.onDown.add(this.onPointerDown, this), 
            this.game.input.onUp.add(this.onPointerUp, this), a.Main.weakDevice ? (this.addTutorHand(), 
            this.currentTask.timer.start()) : (this.pointerEnabled = !1, this.hideItemsOverMonkey(), 
            ...
            this.addBackground(), this.addGrid(), this.itemsLayer = this.game.add.spriteBatch(this.world, "objects_layer"), 
            this.topLayer = this.game.add.group(this.world, "above_items"), this.addLeafs();
        }, c.prototype.addBackground = function() {
            ...
            this.game.add.image(-45, 708, "leafs", "BottomLeft_Leafs0000", this.topLayer), this.game.add.image(460, -45, "leafs", "TopRight_Leafs0000", this.topLayer), 
            ...
            this.monkey = new a.Monkey(this.game, this.topLayer), this.monkey.position.set(a.Config.GAME_WIDTH - 146, a.Config.GAME_HEIGHT - 96), 
            ...
            this.currentTask && (this.currentTask.destroy(), this.currentTask = null), this.currentTask = this.taskGenerator.generateTask(this.level), 
            this.currentTask.timer.completeSignal.addOnce(this.onGameOver, this), this.gui.syncWithTask(this.currentTask, this.level), 
            this.itemsGenerator.setAllowedItemTypes(this.currentTask.allowedItemTypes);
        }, c.prototype.onTaskCompleteStageOne = function() {
            this.gameOver || (this.currentTask.timer.onPause(), this.disableInput(), this.gui.hidePauseButton(), 
            ...
            a ? (this.activateAllPowerUps(), this.game.time.events.add(1200, this.collectFruitsToBasket, this), 
            this.game.time.events.add(3300, this.onTaskCompleteStageThree, this)) : (this.collectFruitsToBasket(), 
            ...
            this.hideItemsOverMonkey(), this.monkey.collectFruits(), this.activeItems.forEach(function(a) {
            ...
            var a = [];
            return a.push(this.grid.getCellAt(6, 5)), a.push(this.grid.getCellAt(6, 6)), a.push(this.grid.getCellAt(7, 4)), 
            a.push(this.grid.getCellAt(7, 5)), a.push(this.grid.getCellAt(7, 6)), a;
            ...
            this.calculateAndSaveResult(), this.roundResult.doReset(), this.level++, this.setNewTask(), 
            this.gui.taskBoard.hideCompleteSignal.addOnce(this.onTaskBoardHide, this), this.gui.taskBoard.show(this.currentTask, this.level);
        }, c.prototype.onTaskBoardHide = function() {
            this.chain.length = 0, this.addItems(), this.hideItemsOverMonkey(), this.dispatchItemsFromMonkey();
        }, c.prototype.dispatchItemsFromMonkey = function() {
            var b = this;
            this.monkey.dispatchFruits(), this.monkey.dispatchFruitsComplete.addOnce(this.onMonkeyDispatchComplete, this), 
            this.activeItems.forEach(function(c) {
                var d = c.x, e = c.y, f = a.Config.GAME_WIDTH - 150, g = a.Config.GAME_HEIGHT - 65, h = Phaser.Math.distance(d, e, f, g), i = 400 + 150 * (c.cell.column + c.cell.row);
            ...
            this.showItemsOverMonkey(), this.currentTask.timer.start(), this.pointerEnabled = !0, 
            this.gui.showPauseButton();
        }, c.prototype.onGameOver = function() {
            this.gameOver = !0, this.disableInput(), this.fadeInAllItems(), this.hideAllChainLinks(), 
            this.gui.onGameOver(this.level, a.Main.stats.totalPoints), this.game.sound.stopAll(), 
            this.game.sound.usingWebAudio && this.game.sound.play("game_over");
        }, c.prototype.calculateAndSaveResult = function() {
            var b = 100, c = this.currentTask.timer.remainingSeconds * b, d = this.roundResult.points + c, e = a.Main.stats.totalPoints + d;
            ...
            if (b) {
                var c = this.grid.position.x + b.x + .5 * b.width, d = this.grid.position.y + b.y + .5 * b.height, e = this.itemsPool.getItem(a);
            ...
            this.gui = new a.LevelGUI(this.game), this.gui.pauseSignal.add(this.togglePause, this), 
            ...
            a.Main.stats.updatePoints(0), this.level = 1, this.setNewTask(), this.removeAllItems(!0), 
            this.destoyAllPowerUps(), this.addItems(), this.currentTask.timer.start(), this.gui.onRestart(), 
            this.pointerEnabled = !0, this.gameOver = !1, this.game.sound.play("main_loop", .33, !0);
            ...
            this.pointerEnabled && (this.pointerDown = !0, this.chain.length = 0, this.chainItemType = null, 
            this.lastItemInChain = null);
        }, c.prototype.onPointerUp = function() {
            this.pointerEnabled && (this.pointerDown = !1, this.hideAllChainLinks(), this.fadeInAllItems(), 
            this.chain.length > 2 ? (this.pointerEnabled = !1, this.chainCollected = !1, this.powerUpsActivated = 0, 
            this.powerUpsCompleted = 0, this.collectItems()) : this.unhighlightChainItems());
        }, c.prototype.collectItems = function() {
            var a = this.currentTask.hasItemType(this.chainItemType);
            a && this.gui.panda.openMouth(), this.checkForTimeBonus(), this.lastItemInChain.collectCompleteSignal.addOnce(this.onChainCollected, this), 
            ...
            if ("undefined" == typeof b && (b = !1), !a.collected) {
                ...
                b || c === !1 ? a.collect() : (this.itemsLayer.bringToTop(a), a.collectToPanda(this.gui.panda.position)), 
                a.clearCell(), this.removeFromActiveItems(a), this.currentTask.onItemCollected(a), 
                this.roundResult.points += 100;
            }
        }, c.prototype.onChainCollected = function() {
            this.chainCollected = !0, this.gui.panda.isMouthOpen() && this.gui.panda.chew(), 
            ...
            this.moveItems(), this.refillGrid(), this.currentTask.onCollectCycleComplete(), 
            ...
            for (var a = this.grid.cells.length, b = a - 1; b >= 0; b--) {
                ...
                if (d && d.dropDistance > 0) {
                    var e = d.position.y + d.dropDistance, f = this.grid.getCellUnderPoint(d.position.x, e);
            ...
            if (this.pointerDown) {
                ...
                if (a) {
                    var b = null === this.chainItemType || this.chainItemType === a.itemType, c = -1 === this.chain.indexOf(a), d = this.lastItemInChain ? this.isDistanceFits(this.lastItemInChain, a) : !0;
                    if (b && c === !1) {
                        var e = this.chain.indexOf(a);
                        if (e === this.chain.length - 2) return this.lastItemInChain.unhighlight(), this.chain.splice(e + 1, 1), 
                        this.lastItemInChain = a, void this.hideLastUsedChainLink();
                    }
                    b && c && d && (this.addItemToChain(a), this.chain.length > 1 && this.showNewChainLink());
                }
            }
        }, c.prototype.addItemToChain = function(a) {
            this.tutorHand && (this.tutorHand.hideAndDestroy(), this.tutorHand = null), this.game.sound.usingWebAudio && this.game.sound.play("select_fruit", .2), 
            ...
            b && (b.position.set(a.x, a.y), b.requestItemSignal.addOnce(this.onStarRequest, this), 
            b.show(), this.game.sound.usingWebAudio && this.game.sound.play("star_appear", .2));
            ...
            c.forEach(function(c) {
                var d = Phaser.Math.distance(a.x, a.y, c.x, c.y), e = .7 * d;
            ...
            var b = a.linkedItem, c = b.cell, d = 0 === a.angle ? this.getItemsInRow(c.row) : this.getItemsInColumn(c.column);
            return d;
            ...
            if (a) {
                var b = this.chain.length, c = this.chain[b - 1], d = this.chain[b - 2];
                Phaser.Point.interpolate(c.position, d.position, .5, this.chainLinkPos), a.position.set(this.chainLinkPos.x, this.chainLinkPos.y), 
                a.rotation = Phaser.Point.angle(d.position, c.position) + .5 * Math.PI, a.show(), 
                this.itemsLayer.sendToBack(a);
            }
        }, c.prototype.getUnusedLink = function() {
            for (var a = this.chainLinks.length, b = 0; a > b; b++) if (this.chainLinks[b].visible === !1) return this.chainLinks[b];
            return null;
            ...
            for (var d = this.activeItems.length, e = 0; d > e; e++) {
                var f = this.activeItems[e], g = utils.MathUtil.distanceSquared(f.position.x, f.position.y, b, c);
            ...
            this.game.state.onShutDownCallback = null, this.roundResult = null, this.activeItems = null, 
            this.itemsGenerator.destroy(), this.itemsGenerator = null, this.chain = null, this.chainLinks = null, 
            this.chainLinkPos = null, this.findChainStrategy.destroy(), this.findChainStrategy = null, 
            this.taskGenerator.destroy(), this.taskGenerator = null, this.currentTask.destroy(), 
            this.currentTask = null, this.monkey = null, this.removeKeyCallbacks(), this.destroyPools();
        }, c.prototype.removeKeyCallbacks = function() {}, c.prototype.destroyPools = function() {
            this.itemsPool.destroy(), this.itemsPool = null, this.starsPool.destroy(), this.starsPool = null, 
            this.powerUpFxsPool.destroy(), this.powerUpFxsPool = null, this.powerUpsPool.destroy(), 
            this.powerUpsPool = null, this.futurePowerUpsPool.destroy(), this.futurePowerUpsPool = null;
        }, c;
    }(Phaser.State);
    a.Level = b;
}(game || (game = {}));
...
!function(a) {
    var b = function() {
        ...
        return a.prototype.init = function() {
            try {
                this.localStorage = window.localStorage, this.localStorage.setItem("testKey", "testData"), 
...
!function(a) {
    var b = function(b) {
        function c(c, d) {
            b.call(this, c, d), this.currentFrame = null, this.tutorialTexts = a.Main.texts.tutorial, 
            this.initBack(), this.initFrames(), this.initText(), this.currentFrame = this.frames[0], 
            this.currentFrame.exists = !0, this.currentFrame.visible = !0, this.updateText();
        }
        return __extends(c, b), c.prototype.initBack = function() {
            ...
            this.frames = [];
            for (var a = 1; 4 >= a; a++) {
                var b = "Tutorial_" + a.toString() + "0000", c = this.game.add.image(0, -70, "tutorial", b, this);
            ...
            this.text = new Phaser.Text(this.game, 0, 130, "", a), this.text.anchor.set(.5, .5), 
            this.text.setShadow(2, 2, "#666666", 2), this.text.wordWrap = !0, this.text.wordWrapWidth = .7 * this.back.width, 
            this.add(this.text);
            ...
            this.currentFrame.exists = !1, this.currentFrame.visible = !1, this.setNewFrame(), 
            this.updateText(), this.showNewFrame();
            ...
            b.prototype.destroy.call(this, !0, !1), this.tutorialTexts = null, this.frames = null, 
...
!function(a) {
    var b = function(b) {
        ...
        return __extends(c, b), c.prototype.create = function() {
            this.game.add.image(0, 0, "main_menu", "main_menu_bg"), this.addBoard(), this.addButton(), 
            this.startAnimation();
            ...
            this.board.alpha = 0, this.board.position.y -= c, this.game.add.tween(this.board.position).to({
                ...
                alpha: 1
            }, 200, Phaser.Easing.Linear.None, !0, a), this.nextButton.position.y += c, this.nextButton.alpha = 0, 
...
!function(a) {
    var b = function(b) {
        function c() {
            ...
            b.call(this, d), c.storage = new utils.LocalStorageWrapper(), c.stats = new a.GameStats(), 
            this.state.add("Boot", a.Boot, !0), this.state.add("Preloader", a.Preloader, !1), 
            this.state.add("MainMenu", a.MainMenu, !1), this.state.add("Tutorial", a.Tutorial, !1), 

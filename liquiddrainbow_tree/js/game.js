...
! function(a) {
    var b = function(b) {
        ...
        return __extends(c, b), c.prototype.preload = function() {
            ...
            this.game.device.webAudio && (this.load.audio("sand_block", ["assets/audio/SandTile.wav"], !0), this.load.audio("valve", ["assets/audio/valve.wav"], !0), this.load.audio("tap", ["assets/audio/TapSound.wav"], !0), this.load.audio("water", ["assets/audio/WaterSound.wav"], !0), this.load.audio("levelComplete", ["assets/audio/LevelCompleteSound.wav"], !0)), this.load.audio("main_loop", ["assets/audio/MainLoop.ogg", "assets/audio/MainLoop.m4a"], !0), this.load.atlasJSONHash("valve", "assets/graphics/valve.png", "assets/graphics/valve.json"), this.load.atlasJSONHash("flower", "assets/graphics/flower.png", "assets/graphics/flower.json"), this.load.atlasJSONHash("gnome", "assets/graphics/gnome.png", "assets/graphics/gnome.json"), this.load.atlasJSONHash("tutorial_hand", "assets/graphics/tutorial_hand.png", "assets/graphics/tutorial_hand.json"), this.load.atlasJSONHash("levelGraphics", "assets/graphics/levelGraphics.png", "assets/graphics/levelGraphics.json"), this.load.atlasJSONHash("gui", "assets/graphics/gui.png", "assets/graphics/gui.json"), a.Main.development ? this.load.json("startLevel", "assets/levels/StartLevel.json") : this.load.json("levelConfigs", "assets/levels/Levels.json")
...
! function(a) {
    var b = function(a) {
        function b(b, c, d, e, f) {
            ...
            var g = this;
            a.call(this, b, c, d, "gui", "Button_Base0000"), this.inputEnabled = !f, this.locked = f, this._levelNumber = e, this.anchor.set(.5, .5), this.createGraphics(), this.inputEnabled && (this.game.device.desktop && (this.input.useHandCursor = !0), this.events.onInputDown.add(function() {
...
! function(a) {
    var b = function(a) {
        ...
        return __extends(b, a), b.prototype.startAddAnimation = function(a) {
            ...
            "undefined" == typeof b && (b = !0), this.addTween && this.game.tweens.remove(this.addTween), this.removeTween && this.game.tweens.remove(this.removeTween), a.prototype.destroy.call(this, b), this._onWaterArriveComplete.dispose(), this._onWaterArriveComplete = null
...
! function(a) {
    var b = function(b) {
        ...
        return __extends(c, b), c.prototype.addTutorialSprite = function(a) {
            ...
            "undefined" == typeof a && (a = !0), "undefined" == typeof c && (c = !1), b.prototype.destroy.call(this, a, c), this.tiles = null, this.flowers = null, this.gnomes = null, this.bounds = null, this.pipes = null, this._sandTilesChanged.dispose(), this._sandTilesChanged = null, this._valveUsed.dispose(), this._valveUsed = null, this._levelCompleteSignal.dispose(), this._levelCompleteSignal = null, this.floodFillStrategy.destroy(), this.floodFillStrategy = null
...
! function(a) {
    var b = function(a) {
        function b(b, c, d) {
            "undefined" == typeof c && (c = 0), "undefined" == typeof d && (d = 0), a.call(this, b, b.world, "FPS Meter"), this.x = c, this.y = d, this.initBackground(), this.initText(), b.time.advancedTiming ? this.loopEvent = this.game.time.events.loop(500, this.updateText, this) : this.statsText.setText("error")
        }

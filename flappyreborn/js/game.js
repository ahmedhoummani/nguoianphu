		...
		(
				{
					...
					1 : [
							function(require, module, exports) {
								...
								var game = new Phaser.Game(288, 505,
										Phaser.AUTO, 'flappy-bird-reborn');
					...
					2 : [
							function(require, module, exports) {
								...
								var Bird = function(game, x, y, frame) {
									...
									this.events.onKilled.add(this.onKilled,
											this);

								};

								Bird.prototype = Object
										.create(Phaser.Sprite.prototype);
								Bird.prototype.constructor = Bird;

								Bird.prototype.update = function() {
									// check to see if our angle is less than 90
									// if it is rotate the bird towards the
									// ground by 2.5 degrees
					...
					3 : [
							function(require, module, exports) {
								...
								var Ground = function(game, x, y, width, height) {
									...
									// to be affected by gravity or external
									// forces
									this.body.allowGravity = false;
								...
								Ground.prototype = Object
										.create(Phaser.TileSprite.prototype);
								Ground.prototype.constructor = Ground;

								Ground.prototype.update = function() {

									// write your prefab's specific update code
									// here
					...
					5 : [
							function(require, module, exports) {
								...
								var PipeGroup = function(game, parent) {
									...
									this.bottomPipe = new Pipe(this.game, 0,
											440, 1);
								...
								PipeGroup.prototype = Object
										.create(Phaser.Group.prototype);
					...
					6 : [
							function(require, module, exports) {
								...
								var Scoreboard = function(game) {
									...
									gameover = this.create(this.game.width / 2,
											100, 'gameover');
									gameover.anchor.setTo(0.5, 0.5);

									this.scoreboard = this.create(
											this.game.width / 2, 200,
											'scoreboard');
									this.scoreboard.anchor.setTo(0.5, 0.5);

									this.scoreText = this.game.add.bitmapText(
											this.scoreboard.width, 180,
											'flappyfont', '', 18);
									this.add(this.scoreText);

									this.bestText = this.game.add.bitmapText(
											this.scoreboard.width, 230,
											'flappyfont', '', 18);
								...
								Scoreboard.prototype.show = function(score) {
									...
									if (score >= 10 && score < 20) {
										coin = this.game.add.sprite(-65, 7,
												'medals', 1);
									} else if (score >= 20) {
										coin = this.game.add.sprite(-65, 7,
												'medals', 0);
									...
									if (coin) {
										...
										// Emitters have a center point and a
										// width/height, which extends from
										// their center point to the left/right
										// and up/down
										...
										// This emitter will have a width of
										// 800px, so a particle can emit from
										// anywhere in the range emitter.x +=
										// emitter.width / 2
										// emitter.width = 800;
										...
										emitter.setAll('body.allowGravity',
												false);
							...
							function(require, module, exports) {
								...
								Menu.prototype = {
									...
									create : function() {
										...
										// and start scrolling in the negative x
										// direction
										this.ground = this.game.add.tileSprite(
												0, 400, 335, 112, 'ground');
										this.ground.autoScroll(-200, 0);

										/** STEP 1 * */
										// create a group to put the title
										// assets in
										...
										this.bird = this.add.sprite(200, 5,
												'bird');
										...
										this.bird.animations.play('flap', 12,
												true);

										/** STEP 5 * */
										// Set the originating location of the
										// group
										this.titleGroup.x = 30;
										this.titleGroup.y = 100;

										/** STEP 6 * */
										// create an oscillating animation tween
										// for the group
										this.game.add
										...
										// add our start button with a callback
										this.startButton = this.game.add
												.button(this.game.width / 2,
														300, 'startButton',
										...
										this.duck = this.add.sprite(5, 5,
												'duck');
										this.titleGroup.add(this.duck);

										this.duck.animations.add('right');

										this.duck.animations.play('right', 12,
												true);

										// ship
										this.ship = this.add.sprite(5, 100,
												'ship');
					...
					9 : [
							function(require, module, exports) {
								...
								Play.prototype = {
									create : function() {
										// start the phaser arcade physics
										// engine
										this.game.physics
												.startSystem(Phaser.Physics.ARCADE);

										// give our world an initial gravity of
										// 1200
										...
										// create and add a group to hold our
										// pipeGroup prefabs
										...
										this.flapKey = this.game.input.keyboard
												.addKey(Phaser.Keyboard.SPACEBAR);
										this.flapKey.onDown.addOnce(
												this.startGame, this);
										this.flapKey.onDown.add(this.bird.flap,
												this.bird);
										...
										this.game.input.onDown.add(
												this.bird.flap, this.bird);

										// keep the spacebar from propogating up
										// to the browser
										this.game.input.keyboard
												.addKeyCapture([ Phaser.Keyboard.SPACEBAR ]);

										this.score = 0;
										this.scoreText = this.game.add
												.bitmapText(
														this.game.width / 2,
														10, 'flappyfont',
														this.score.toString(),
										...
										this.instructionGroup = this.game.add
												.group();
										this.instructionGroup.add(this.game.add
												.sprite(this.game.width / 2,
														100, 'getReady'));
										this.instructionGroup.add(this.game.add
												.sprite(this.game.width / 2,
														325, 'instructions'));
										this.instructionGroup.setAll(
												'anchor.x', 0.5);
										this.instructionGroup.setAll(
												'anchor.y', 0.5);
										...
										this.pipeHitSound = this.game.add
												.audio('pipeHit');
										this.groundHitSound = this.game.add
												.audio('groundHit');
										this.scoreSound = this.game.add
												.audio('score');

									},
									update : function() {
										// enable collisions between the bird
										// and the ground
										this.game.physics.arcade.collide(
												this.bird, this.ground,
												this.deathHandler, null, this);

										if (!this.gameover) {
											// enable collisions between the
											// bird and each group in the pipes
											// group
											this.pipes
													.forEach(
															function(pipeGroup) {
									...
									shutdown : function() {
										this.game.input.keyboard
												.removeKey(Phaser.Keyboard.SPACEBAR);
										this.bird.destroy();
										this.pipes.destroy();
									...
									startGame : function() {
										if (!this.bird.alive && !this.gameover) {
											...
											// add a timer
											this.pipeGenerator = this.game.time.events
													.loop(
									...
									generatePipes : function() {
										var pipeY = this.game.rnd
												.integerInRange(-100, 100);
										var pipeGroup = this.pipes
												.getFirstExists(false);
										if (!pipeGroup) {
											pipeGroup = new PipeGroup(
													this.game, this.pipes);
										}
								...
								Preload.prototype = {
									preload : function() {
										...
										this.load.audio('flap',
												'assets/flap.wav');
										this.load.audio('pipeHit',
												'assets/pipe-hit.wav');
										this.load.audio('groundHit',
												'assets/ground-hit.wav');
...
//									this.animations.add('right');
								...
								Duck.prototype = Object
										.create(Phaser.Sprite.prototype);
								Duck.prototype.constructor = Duck;

								Duck.prototype.update = function() {
									// check to see if our angle is less than 90
									// if it is rotate the Duck towards the
									// ground by 2.5 degrees
									if (this.angle < 90 && this.alive) {
										this.angle += 2.5;
									}
					...
					12 : [
							function(require, module, exports) {
								...
								var Ship = function(index, game, player,
										bullets) {
									...
									this.ship.animations.add('left', [ 0 ], 20,
											true);
									this.ship.animations.add('right', [ 1 ],
											20, true);
									...
									// if (Math.abs(this.ship.body.velocity.x)
									// != 0 ){
									...
									// Tell it we don't want physics to manage
									// the rotation
								...
								Ship.prototype.update = function() {
									...
									// this.game.physics.arcade.angleBetween(this.ship,
									// this.player);

									if (300 < this.game.physics.arcade
											.distanceBetween(this.ship,
													this.player)
											&& this.game.physics.arcade
													.distanceBetween(this.ship,
															this.player) < 350) {
										if (this.game.time.now > this.nextFire
											...
											bullet.reset(this.ship.x,
													this.ship.y);

											bullet.rotation = this.game.physics.arcade
													.moveToObject(bullet,
															this.player, 50);
										}
									}
